...
?>
 ...
 <body onload="setTimeout('init();', 100);" style="background:#f000000">
  <center>
   <b><font face="Arial" color="#000000">RPI Cam Birdhouse interface</b>
   
   
   
   <form method="post">
    <table border='1' align='center' bgcolor='#000000' bordercolor='#000000'  cellpadding='3'>
     <tr>
      <td>LED white</td>
      <td><br>
       <button name="button_on_white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ON&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <button name="button_off_white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OFF&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button><br>
      </td>
     </tr><br>
     <tr>
      <td>LED IR</td>
     ...
     <tr>
      <td>Temperature</td>
      <td align="center"><?php echo "<p>$time&deg;C</p>"; ?></td>
     </tr>&nbsp;
     <tr>
      <td>Humidity</td>
      <td align="center"><?php echo "<p>$temp%</p>"; ?></td>
     </tr>&nbsp;
     <tr>
      <td>dhbkhn</td>
   ...
   <p>
    <input type="button" onclick="document.location.href='parameters.php';" value="Paremeters.phanquoctrung">
   </p>
  </center>
 </body>
</html>
...
<html>
  ...
  // trung       <div><img id="mjpeg_dest" <?php if(file_exists("pipan_on")) echo "ontouchstart=\"pipan_start()\""; ?> onclick="toggle_fullscreen(this);" src="/loading.jpg"></div>    */
